...
public class Constants {
    ...
    static {
        BAY_AREA_LANDMARKS.put("Dom", new LatLng(52.3896293, 16.9741182));
        BAY_AREA_LANDMARKS.put("Czarnkow", new LatLng(52.9018021, 16.5649313));
        BAY_AREA_LANDMARKS.put("Kinguin", new LatLng(52.4271323,16.8991132));
    }
}
